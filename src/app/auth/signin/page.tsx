...
import { Zap, Shield, FileText, Users, Sparkles } from 'lucide-react';

// Google Icon Component (Official Google Colors)
const GoogleIcon = () => (
...
const features = [
  { icon: FileText, text: 'Professional Invoicing', color: 'text-indigo-400' },
  { icon: Users, text: 'Customer Management', color: 'text-pink-400' },
  { icon: Shield, text: 'Secure & Reliable', color: 'text-emerald-400' },
];
      ...
      >
        ...
        <div className="glass-card p-8 rounded-2xl border border-white/10 backdrop-blur-xl">
          ...
          <motion.button
            ...
            className="w-full bg-white hover:bg-gray-50 text-gray-800 font-medium py-3.5 px-4 rounded-xl flex items-center justify-center gap-3 transition-all shadow-lg hover:shadow-xl"
          >
            <GoogleIcon />
        ...
        >
          <p className="text-white/30 text-xs">
            Powered by <span className="text-white/50 font-medium">Yurekh Solutions</span>
          </p>
        </motion.div>
      </motion.div>
    </div>
