        ...
        >
          ...
          >
            ...
            <p className="text-lg leading-relaxed text-gray-600">
              Create your account and unlock powerful invoicing, CRM, and analytics tools to grow your business.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative text-center mb-6">
              ...
              >
                ...
                <span className="text-sm font-semibold text-purple-600">Create Account</span>
              </motion.div>
            ...
            {success ? (
              ...
              <>
                ...
                >
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500">or register with email</span>
                  <div className="flex-1 h-px" style={{ background: 'linear-gradient(90deg, transparent, rgba(99,102,241,0.2), transparent)' }} />
                </motion.div>
