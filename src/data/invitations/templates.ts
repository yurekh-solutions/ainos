...
const BASE_TEMPLATES = [
  ...
  // ========== GANPATI (10 unique, invitemitra-style names) ==========
  // _id prefix is 'gp' because the generated catalogue already owns 'g<n>'.
  { _id: 'gp1', name: 'Bappa Sawari', slug: 'bappa-sawari', category: 'ganpati', previewImage: '/templates/ganpati-01.png', language: 'marathi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'royal-maroon', sampleText: { blessing: '|| Ganpati Bappa Morya ||', event: 'Bappa Sawari', date: 'Monday, 14 September 2026' }},
  { _id: 'gp2', name: 'Gulabi Makhar', slug: 'gulabi-makhar', category: 'ganpati', previewImage: '/templates/ganpati-02.png', language: 'hindi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'rose-blush', sampleText: { blessing: '|| Shri Ganeshay Namah ||', event: 'Gulabi Makhar', date: 'Monday, 14 September 2026' }},
  { _id: 'gp3', name: 'Chandra Bappa', slug: 'chandra-bappa', category: 'ganpati', previewImage: '/templates/ganpati-03.png', language: 'marathi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'peacock-teal', sampleText: { blessing: '|| Chandra Bappa Mandala ||', event: 'Chandra Bappa', date: 'Monday, 14 September 2026' }},
  { _id: 'gp4', name: 'Modak Mandir', slug: 'modak-mandir', category: 'ganpati', previewImage: '/templates/ganpati-04.png', language: 'hindi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'gold-leaf', sampleText: { blessing: '|| Modak Priya ||', event: 'Modak Mandir', date: 'Monday, 14 September 2026' }},
  { _id: 'gp5', name: 'Sinhasan', slug: 'sinhasan', category: 'ganpati', previewImage: '/templates/ganpati-05.png', language: 'marathi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'antique-gold', sampleText: { blessing: '|| Simhasan Adhisthata ||', event: 'Sinhasan Pujan', date: 'Tuesday, 15 September 2026' }},
  { _id: 'gp6', name: 'Lalbaugcha Raja', slug: 'lalbaugcha-raja', category: 'ganpati', previewImage: '/templates/ganpati-06.png', language: 'marathi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'royal-maroon', sampleText: { blessing: '|| Lalbaugcha Raja ||', event: 'Lalbaugcha Raja Darshan', date: 'Monday, 14 September 2026' }},
  { _id: 'gp7', name: 'Dudh Abhishek', slug: 'dudh-abhishek', category: 'ganpati', previewImage: '/templates/ganpati-07.png', language: 'hindi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'ivory-cream', sampleText: { blessing: '|| Dungdha Abhishek ||', event: 'Dudh Abhishek Mahotsav', date: 'Monday, 14 September 2026' }},
  { _id: 'gp8', name: 'Shubh Aagman', slug: 'shubh-aagman', category: 'ganpati', previewImage: '/templates/ganpati-08.png', language: 'marathi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'soft-brown', sampleText: { blessing: '|| Shubh Aagman ||', event: 'Bappa Aagman', date: 'Monday, 14 September 2026' }},
  { _id: 'gp9', name: 'Dhol Tasha', slug: 'dhol-tasha', category: 'ganpati', previewImage: '/templates/ganpati-09.png', language: 'marathi', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'deep-burgundy', sampleText: { blessing: '|| Dhol Tasha Ghoshayatra ||', event: 'Bappa Utsav', date: 'Monday, 14 September 2026' }},
  { _id: 'gp10', name: 'Southern Blessings', slug: 'southern-blessings', category: 'ganpati', previewImage: '/templates/tpl-ganpati-2.jpg', language: 'english', hasVideo: true, price: 49, videoPrice: 99, recommendedColor: 'gold-leaf', sampleText: { blessing: '|| Vighnaharta Blessings ||', event: 'Ganesh Chaturthi', date: 'Monday, 14 September 2026' }},
